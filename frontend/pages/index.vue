...
<template>
  ...
  <section class="Homepage_section__hp0I_ Homepage_section_column__5YD3p BucketListSection_bucketList__section__kmFFL">
      ...
      <div class="w-layout-grid _1-2-grid">
        <div class="content-wrap">
          ...
          <p class="paragraph-11">We see an big opportunity to deliver a superior experience for discovering and
            planning your next vacation. Our aim is to offer increasingly reliable, user-centric products for travelers
            worldwide.</p>
        ...
        <div class="w-layout-grid _1-3-grid">
          <div id="w-node-d598884f-1d19-2366-1050-61c2e001b8c9-eee4a83f"
            ...
            <div class="card-inner">
              ...
              <p class="paragraph-11">Create a free account to get limited access to our platform and become part of our
                growing community.</p>
